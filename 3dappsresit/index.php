...
<body>
    ...
    <div class="container-fluid" padding>
        <div class="row welcome text-center">
            ...
            <hr>
            <div class="col-12">
                <p class="lead">Coke, Fanta and Sprite are bestsellers right now! We have something for everyone! click and hold to move models!</p>
            </div>
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row jumbotron">
            <div class="col-xs-12 col-sm12 col-md-9 col-lg-9 col-xl-10">
                <p class="lead">Models were made in Blender then exported to x3d, click button to see more</p>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 col-xl-2">
                <a href="swap.php"><button type="button" class="btn btn-secondary btn-lg">Shop By Drink Type</button></a>
            </div>
        </div>
    </div>
